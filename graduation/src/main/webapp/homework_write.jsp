  ...
  <div class="container">
		...
		<div class="flex-shrink-0 custom-padding">
			<div class="noticepart">
				...
				<a class="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
      				<span class="fs-5 fw-semibold">과제게시판 작성</span>
    			</a>   
            
            
           <form action="homeworkup.do" method="post" enctype="multipart/form-data">  <!-- action 바꿔야함 -->
            ...
            <%  String loggedInUserName = (String) session.getAttribute("loggedInUserName"); %>
                  ...
                  <div class="form-group" style="display:none;">
                     ...
                     <input type="text" class="form-control" name="author" id="author" value="<%= loggedInUserName %>">
                  </div>
                  <div class="form-group" style="margin-bottom:20px;">
            ...
            <div class = "filebox" style="margin-top:70px; margin-bottom:40px;"><input class = "upload-name" value="첨부파일" placeholder="첨부파일"/>
            <label for ="file">파일 찾기</label>
            <input type = "file"  name="homeworkfile" id="file"></div>
