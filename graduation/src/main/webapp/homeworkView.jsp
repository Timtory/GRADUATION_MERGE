...
<script>
        function showPost(postId, title, author, ctime) {
            ...
            var url = "homeworklook.jsp?post_id=" + postId +
...
%>
			...
			<section class="numbar">
					...
					<div class="board_page">
						...
						%>
						<a href="<%="homeworkView.jsp?page=" + i%>"
    ...
    function checkAndNavigateToPreviousPage() {
        ...
        if (currentPage === 1) {
            ...
            window.location.href = "homeworkView.jsp?page=" + previousPage;
        }
    }
    ...
    function checkAndNavigateToNextPage() {
        ...
        if (currentPage === totalPages) {
            ...
            window.location.href = "homeworkView.jsp?page=" + (currentPage + 1);
        }
    }
</script>
...
<script>
    function checkLoggedInUser() {
        ...
        if (loggedInUserName == null || loggedInUserName =="null") {
        	...
        	// 사용자가 로그인한 경우, "homework_write.jsp" 페이지로 이동합니다.
            window.location.href = "homework_write.jsp";	//변경해야됌
        }
    }
</script>
