		...
		<div class="flex-shrink-0 custom-padding">
    			...
    			<div class="hstack gap-3 border-bottom pb-1 mb-1">
                    <div class="p-2">
                        <a class="d-flex align-items-center link-body-emphasis text-decoration-none">
                              <span class="fs-5 fw-semibold">인기 게시글</span>
                        </a> 
                    </div>
			...
			<section class="sc1">
				...
				try {
					...
					String countQuery = "SELECT COUNT(*) AS totalPosts FROM jdbc_test where recommand > 10";
                    ...
                    String query = "SELECT post_id, title, author, ctime, recommand, views FROM jdbc_test where recommand > 10 ORDER BY recommand DESC LIMIT ? OFFSET ?";
...
%>
    ...
    function checkAndNavigateToPreviousPage() {
        ...
        if (currentPage === 1) {
            ...
            window.location.href = "hot.jsp?page=" + previousPage;
        }
    }
    ...
    function checkAndNavigateToNextPage() {
        ...
        if (currentPage === totalPages) {
            ...
            window.location.href = "hot.jsp?page=" + (currentPage + 1);
        }
    }
</script>
