	...
	<div class="container">
		...
		<div class="flex-shrink-0 custom-padding">
			<div class="noticepart">
    			...
    			<div class="hstack gap-3 border-bottom pb-1 mb-1">
                    <div class="p-2">
                        <a class="d-flex align-items-center link-body-emphasis text-decoration-none">
                              <span class="fs-5 fw-semibold">전체 게시글</span>
                        </a> 
                    </div>
			...
			<section class="sc1">
				...
				try {
					...
					String countQuery = "SELECT COUNT(*) AS totalPosts FROM jdbc_test";
					...
					String query = "SELECT post_id, title, author, ctime, views FROM jdbc_test ORDER BY ctime DESC LIMIT ? OFFSET ?";
					...
					while (resultSet.next()) {
						...
						java.util.Date date = originalFormat.parse(ctime);
...
%>
			...
			<section class="numbar">
					...
					<div class="board_page">
						...
						%>
						<a href="<%="total_list_Student.jsp?page=" + i%>"
    ...
    function checkAndNavigateToPreviousPage() {
        ...
        if (currentPage === 1) {
            ...
            window.location.href = "total_list_Student.jsp?page=" + previousPage;
        }
    }
    ...
    function checkAndNavigateToNextPage() {
        ...
        if (currentPage === totalPages) {
            ...
            window.location.href = "total_list_Student.jsp?page=" + (currentPage + 1);
        }
    }
</script>
    ...
    function performSearch() {
        ...
        var searchUrl = "search.jsp?query=" + encodedQuery;
