...
<script>
        function showPost(postId, title, author, ctime) {
            ...
            var url = "suggestionlook.jsp?post_id=" + postId +
...
<body>
<form action="suggestion_delete.jsp" method="post">
	<div class="container">
		<div class="asdf">
		...
		<div class="flex-shrink-0 custom-padding">
			<div class="noticepart">
				...
				<a class="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
      				<span class="fs-5 fw-semibold">건의사항</span>
    			</a>   
			...
			<section class="sc1">
				...
				try {
					...
					String countQuery = "SELECT COUNT(*) AS totalPosts FROM suggestion";
                    ...
                    String query = "SELECT post_id, title, author, ctime FROM suggestion ORDER BY ctime DESC LIMIT ? OFFSET ?";
...
%>
			...
			<section class="numbar">
					...
					<div class="board_page">
						...
						%>
						<a href="<%="suggestionView.jsp?page=" + i%>"
    ...
    function checkAndNavigateToPreviousPage() {
        ...
        if (currentPage === 1) {
            ...
            window.location.href = "suggestionView.jsp?page=" + previousPage;
        }
    }
    ...
    function checkAndNavigateToNextPage() {
        ...
        if (currentPage === totalPages) {
            ...
            window.location.href = "suggestionView.jsp?page=" + (currentPage + 1);
        }
    }
</script>
