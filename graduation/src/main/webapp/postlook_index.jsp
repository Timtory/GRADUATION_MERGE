      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
		...
		<div class="user-info">
                <%
                    ...
                    if (loggedInUserName1 != null) { %> 
                        <p style="color: white; font-weight: bold;"><%= loggedInUserName1 %>님 환영합니다.</p>
        ...
        <div class="asdf">
            ...
            %>
                <div>
                    ...
                    <div class="p-2">
                    <form method="post" action="rectest2.jsp?title=<%= title1 %>">
			  ...
			  <div class="comment-form">
			    <form action="addcomment1.do" method="post" enctype="multipart/form-data">
