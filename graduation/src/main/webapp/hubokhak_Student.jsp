	...
	<div class="container">
		...
		<div class="flex-shrink-0 custom-padding">
			<div class="noticepart">
				...
				<a class="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
      				<span class="fs-5 fw-semibold">휴복학</span>
...
document.getElementById("searchQuery").addEventListener("keypress", handleKeyPress);
			...
			<section class="sc1">
				...
				try {
					...
					String countQuery = "SELECT COUNT(*) AS totalPosts FROM jdbc_test where tag ='휴복학'";
                    ...
                    String query = "SELECT post_id, title, author, ctime, tag, views FROM jdbc_test WHERE tag ='휴복학' ORDER BY ctime DESC LIMIT ? OFFSET ?";
...
%>
			...
			<section class="numbar">
					...
					<div class="board_page">
						...
						%>
						<a href="<%="hubokhak_Student.jsp?page=" + i%>"
    ...
    function checkAndNavigateToPreviousPage() {
        ...
        if (currentPage === 1) {
            ...
            window.location.href = "hubokhak_Student.jsp?page=" + previousPage;
        }
    }
    ...
    function checkAndNavigateToNextPage() {
        ...
        if (currentPage === totalPages) {
            ...
            window.location.href = "hubokhak_Student.jsp?page=" + (currentPage + 1);
        }
    }
</script>
    ...
    function performSearch() {
        ...
        var searchUrl = "search_hubokhak.jsp?query=" + encodedQuery;
