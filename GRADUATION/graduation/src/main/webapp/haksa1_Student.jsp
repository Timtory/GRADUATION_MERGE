...
document.getElementById("searchQuery").addEventListener("keypress", handleKeyPress);
			...
			<section class="sc1">
				...
				try {
                    ...
                    String query = "SELECT post_id, title, author, ctime, tag, views FROM jdbc_test WHERE tag ='학사' ORDER BY post_id DESC LIMIT ? OFFSET ?";
...
%>
			...
			<section class="numbar">
					...
					<div class="board_page">
						...
						%>
						<a href="<%="haksa1_Student.jsp?page=" + i%>"
    ...
    function checkAndNavigateToPreviousPage() {
        ...
        if (currentPage === 1) {
            ...
            window.location.href = "haksa1_Student.jsp?page=" + previousPage;
        }
    }
    ...
    function checkAndNavigateToNextPage() {
        ...
        if (currentPage === totalPages) {
            ...
            window.location.href = "haksa1_Student.jsp?page=" + (currentPage + 1);
        }
    }
</script>
