...
<%-- <nav>
    <div class="container">
        <ul>
              <a href="index.jsp"><img class="img1" src="신한대학교ui.jpg" /></a>
        </ul>
        <ul id="ul1">
        	<li><a href="hotreal.jsp">실시간 HOT 게시글</a></li>
        	<li> <a href="totallist_Student_Real.jsp">태그별 게시판<i class='fa fa-angle-down'></i></a>
               <ul>
                  <li><a href="haksa_Student_Real.jsp">학사</a></li>
                  <li><a href="janghak_Student_Real.jsp">장학</a></li>
                  <li><a href="haksang_dongari_Student_Real.jsp">학생회, 동아리</a></li>
                  <li><a href="hubokhak_Student_Real.jsp">휴복학</a></li>
                  <li><a href="changup_Student_Real.jsp">취창업</a></li>
                  <li><a href="education_festival_Student_Real.jsp">교육행사</a></li>
               </ul>
            </li>
            <li class='sub-menu'> <a href="gradeall_Student_Real.jsp">학년별 게시판<i class='fa fa-angle-down'></i></a>
               <ul>
        	...
        	<li class='sub-menu'> <a href="#">학교 홈페이지<i class='fa fa-angle-down'></i></a>
               <ul>
                  <li><a href="https://www.shinhan.ac.kr/sites/kr/index.do" target="_blank">신한대학교 홈페이지<img id="link" src="img/link.png"/></a></li>
                  <li><a href="https://cyber.shinhan.ac.kr/login.php" target="_blank">신한대학교 사이버 캠퍼스<img id="link" src="img/link.png"/></a></li>
                  <li><a href="https://stins.shinhan.ac.kr/irj/portal" target="_blank">신한대학교 종합정보시스템<img id="link" src="img/link.png"/></a></li>
               </ul>
            </li>
            <li><a href="student_write_suggestion_Real.jsp">건의사항 작성</a></li>
        </ul>
         <%
            String loggedInUserName = (String) session.getAttribute("loggedInUserName");
                ...
                <a href="LogoutServlet"><img id="login_img" src="img/logout.png" alt="로그아웃" /></a>
                <%   
            } else {%>
...
<iframe src="total_list_Student.jsp" width="100%" height="800" frameborder="0"></iframe>
