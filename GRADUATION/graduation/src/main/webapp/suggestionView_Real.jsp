    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav ml-lg-2 col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        	...
        	<li class="nav-item">
          		<a class="nav-link" href="total_listReal.jsp">게시글</a>
        	</li>
        	<li class="nav-item">
        	...
        	<li class="nav-item">
          		<a class="nav-link" href="https://danbee.ai/platform/#/loginPrivateStep"  target="_blank">챗봇관리</a>
        	</li>
        	<li class="nav-item">
          		<a class="nav-link" href="carouselSetting_Real.jsp">캐러셀</a>
        	</li>
        	<li class="nav-item">
          		<a class="nav-link" href="homeworkView_Real.jsp">파일제출</a>
        	</li>
        	<li class="nav-item">
          		<a class="nav-link" href="suggestionView_Real.jsp">건의사항</a>
        	</li>
...
<iframe src="suggestionView.jsp" width="100%" height="800" frameborder="0"></iframe>
