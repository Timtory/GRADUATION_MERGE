...
<script>
        function showPost(postId, title, author, ctime) {
            // 게시글 정보를 URL 매개변수로 조합하여 suggestionlook.jsp로 이동
            var url = "homeworklook_Student.jsp?post_id=" + postId +
...
<body>
<form action="homework_delete.jsp" method="post">
	<div class="container">
		<div class="asdf">
		...
		<div class="flex-shrink-0 custom-padding">
			<div class="noticepart">
				...
				<a class="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
      				<span class="fs-5 fw-semibold">파일제출</span>
    			</a>   
			...
			<section class="sc1">
				...
				try {
					...
					String countQuery = "SELECT COUNT(*) AS totalPosts FROM hw";
                    ...
                    String query = "SELECT post_id, title, author, ctime FROM hw ORDER BY post_id DESC LIMIT ? OFFSET ?";
            ...
            %>	
            		<ul style="top: 20px;">
						<li style="height: 20px;">
                            ...
                            <span class="notify"><a href="javascript:void(0);" onclick="showPost(<%=postId%>, '<%=title%>', '<%=author%>');"><%=title%></a></span>
			...
			<section class="numbar">
					...
					<div class="board_page">
						...
						%>
						<a href="<%="homework_Student_View.jsp?page=" + i%>"
    ...
    function checkAndNavigateToPreviousPage() {
        ...
        if (currentPage === 1) {
            ...
            window.location.href = "homework_Student_View.jsp?page=" + previousPage;
        }
    }
    ...
    function checkAndNavigateToNextPage() {
        ...
        if (currentPage === totalPages) {
            ...
            window.location.href = "homework_Student_View.jsp?page=" + (currentPage + 1);
        }
    }
</script>
